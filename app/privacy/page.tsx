...
export default function PrivacyPage() {
  return (
    <LegalDocument title="Privacy Policy" updatedAt="2026-08-20">
      <section>
        <p>
          Friday Career Coaching (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or
          ...
          disclosed by Friday Career Coaching.
        </p>
        <p>
          This Privacy Policy applies to our website, and its associated subdomains
          (collectively, our &ldquo;Service&rdquo;) alongside our application, Friday
          Career Coaching. By accessing or using our Service, you signify that you have
          read, understood, and agree to our collection, storage, use, and disclosure
          of your personal information as described in this Privacy Policy and our
          Terms of Service.
        </p>
      </section>

      <section>
        <h2 className="font-display text-lg font-bold mb-2">Definitions and key terms</h2>
        <p>
        ...
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li>
            <strong>Customer:</strong> refers to the company, organization or person
            that signs up to use the Friday Career Coaching Service to manage the
          ...
          <li>
            ...
            assigned a number known as an Internet protocol (IP) address. These numbers
            are usually assigned in geographic blocks. An IP address can often be used
          ...
          <li>
            ...
            Friday Career Coaching or are under contract to perform a service on behalf
            of one of the parties.
          </li>
          <li>
            <strong>Personal Data:</strong> any information that directly, indirectly,
            or in connection with other information &mdash; including a personal
      ...
      <section>
        <h2 className="font-display text-lg font-bold mb-2">What Information Do We Collect?</h2>
        <p>
      ...
      <section>
        <h2 className="font-display text-lg font-bold mb-2">
          When does Friday Career Coaching use end user information from third parties?
        </h2>
        <p>
          Friday Career Coaching will collect End User Data necessary to provide the
          Friday Career Coaching services to our customers.
        </p>
        <p>
      ...
      <section>
        <h2 className="font-display text-lg font-bold mb-2">
          When does Friday Career Coaching use customer information from third parties?
        </h2>
        <p>
          ...
          becoming a Friday Career Coaching customer, we receive information from a
          third party that provides automated fraud detection services to Friday
          Career Coaching. We also occasionally collect information that is made
      ...
      <section>
        ...
        <p>
          ...
          marketing, credit card processing, customer service and fulfilling orders for
          products and services you may purchase through the website. We will likely
          share your personal information, and possibly some non-personal information,
          with these third parties to enable them to perform these services for us and
          for you.
        </p>
        <p>
          ...
          application developers, and ad networks. If your IP address is shared, it may
          be used to estimate general location and other technographics such as
          connection speed, whether you have visited the website in a shared location,
          and type of the device used to visit the website. They may aggregate
          information about our advertising and what you see on the website and then
      ...
      <section>
        ...
        <p>
          Friday Career Coaching will collect personal information that you submit to
          us. We may also receive personal information about you from third parties as
          described above.
        </p>
      </section>

      <section>
        <h2 className="font-display text-lg font-bold mb-2">How Do We Use Your Email Address?</h2>
        <p>
          By submitting your email address on this website, you agree to receive
          emails from us. You can cancel your participation in any of these email lists
          at any time by clicking on the opt-out link or other unsubscribe option that
          is included in the respective email. We only send emails to people who have
          ...
          receive communications from us. Email addresses submitted only through the
          order processing page will be used for the sole purpose of sending you
          information and updates pertaining to your order. If, however, you have
          provided the same email to us through another method, we may use it for any
          of the purposes stated in this Policy. Note: If at any time you would like to
      ...
      <section>
        <h2 className="font-display text-lg font-bold mb-2">How Long Do We Keep Your Information?</h2>
        <p>
          We keep your information only so long as we need it to provide Friday Career
          Coaching to you and fulfill the purposes described in this policy. This is
          also the case for anyone that we share your information with and who carries
          out services on our behalf. When we no longer need to use your information
          and there is no need for us to keep it to comply with our legal or regulatory
          obligations, we&rsquo;ll either remove it from our systems or depersonalize it
          so that we can&rsquo;t identify you.
        </p>
      </section>

      <section>
        <h2 className="font-display text-lg font-bold mb-2">How Do We Protect Your Information?</h2>
        <p>
          ...
          or warrant the absolute security of any information you transmit to Friday
          Career Coaching or guarantee that your information on the Service may not be
      ...
      <section>
        ...
        <p>
          Friday Career Coaching is incorporated in United Kingdom. Information
          collected via our website, through direct interactions with you, or from use
          of our help services may be transferred from time to time to our offices or
          personnel, or to third parties, located throughout the world, and may be
          viewed and hosted anywhere in the world, including countries that may not
          have laws of general applicability regulating the use and transfer of such
          data. To the fullest extent allowed by applicable law, by using any of the
          above, you voluntarily consent to the trans-border transfer and hosting of
          such information.
        </p>
      </section>
      ...
      <section>
        <h2 className="font-display text-lg font-bold mb-2">
          Is the information collected through the Friday Career Coaching Service secure?
        </h2>
        <p>
          ...
          its absolute security. If applicable law imposes any non-disclaimable duty to
          protect your personal information, you agree that intentional misconduct will
          be the standards used to measure our compliance with that duty.
        </p>
      </section>

      <section>
        <h2 className="font-display text-lg font-bold mb-2">Can I update or correct my information?</h2>
        <p>
          The rights you have to request updates or corrections to the information
          Friday Career Coaching collects depend on your relationship with Friday
          Career Coaching. Personnel may update or correct their information as
        ...
        <p>
          If you are an end user and wish to update, delete, or receive any information
          we have about you, you may do so by contacting the organization of which you
          are a customer.
        </p>
      </section>

      <section>
        <h2 className="font-display text-lg font-bold mb-2">Sale of Business</h2>
        <p>
          ...
          Friday Career Coaching or any of its Corporate Affiliates (as defined
          herein), or that portion of Friday Career Coaching or any of its Corporate
      ...
      <section>
        <h2 className="font-display text-lg font-bold mb-2">Affiliates</h2>
        <p>
          We may disclose information (including personal information) about you to
          our Corporate Affiliates. For purposes of this Privacy Policy, &ldquo;Corporate
          Affiliate&rdquo; means any person or entity which directly or indirectly
          controls, is controlled by or is under common control with Friday Career
          Coaching, whether by ownership or otherwise. Any information relating to you
      ...
      <section>
        ...
        <p>
          This Privacy Policy is governed by the laws of United Kingdom without regard
          to its conflict of laws provision. You consent to the exclusive jurisdiction
          of the courts in connection with any action or dispute arising between the
          parties under or in connection with this Privacy Policy except for those
          individuals who may have rights to make claims under Privacy Shield, or the
          Swiss-US framework.
        </p>
        <p>
          The laws of United Kingdom, excluding its conflicts of law rules, shall
          govern this Agreement and your use of the website. Your use of the website
          may also be subject to other local, state, national, or international laws.
        </p>
        <p>
          By using Friday Career Coaching or contacting us directly, you signify your
      ...
      <section>
        ...
        <p>
          We&rsquo;ve updated our Privacy Policy to provide you with complete
          transparency into what is being set when you visit our site and how
          it&rsquo;s being used. By using our website, registering an account, or
      ...
      <section>
        ...
        <p>
          ...
          links to other websites not operated or controlled by Friday Career
      ...
      <section>
        ...
        <p>
          Friday Career Coaching uses &ldquo;Cookies&rdquo; to identify the areas of our
          website that you have visited. A Cookie is a small piece of data stored on
      ...
      <section>
        ...
        <p>
          Wherever you&rsquo;re located you may also set your browser to block cookies
          and similar technologies, but this action may block our essential cookies and
          prevent our website from functioning properly, and you may not be able to
          fully utilize all of its features and services. You should also be aware that
          you may also lose some saved information (e.g. saved login details, site
          preferences) if you block cookies on your browser. Different browsers make
          different controls available to you. Disabling a cookie or category of cookie
          does not delete the cookie from your browser, you will need to do this
          yourself from within your browser, you should visit your browser&rsquo;s help
          menu for more information.
        </p>
      </section>

      <section>
        <h2 className="font-display text-lg font-bold mb-2">Kids&rsquo; Privacy</h2>
        <p>
      ...
      <section>
        <h2 className="font-display text-lg font-bold mb-2">Changes To Our Privacy Policy</h2>
        <p>
          We may change our Service and policies, and we may need to make changes to
          this Privacy Policy so that they accurately reflect our Service and policies.
          ...
          to use the Service, you will be bound by the updated Privacy Policy. If you
          do not want to agree to this or any updated Privacy Policy, you can delete
          your account.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          links to third-party websites or services (&ldquo;Third-Party
          Services&rdquo;).
        </p>
        <p>
        ...
        <p>
          ...
          such third parties&rsquo; terms and conditions.
        </p>
      </section>

      <section>
        <h2 className="font-display text-lg font-bold mb-2">Tracking Technologies</h2>
        <p><strong>Cookies</strong></p>
        <p>
          We use Cookies to enhance the performance and functionality of our website
          ...
          enter your login details every time you visit the website as we would not be
          able to remember that you had logged in previously.
        </p>
        <p><strong>Local Storage</strong></p>
        <p>
          Local Storage sometimes known as DOM storage, provides web apps with methods
          and protocols for storing client-side data. Web storage supports persistent
          data storage, similar to cookies but with a greatly enhanced capacity and no
          information stored in the HTTP request header.
        </p>
        <p><strong>Sessions</strong></p>
        <p>
          Friday Career Coaching uses &ldquo;Sessions&rdquo; to identify the areas of
          our website that you have visited. A Session is a small piece of data stored
      ...
      <section>
        <h2 className="font-display text-lg font-bold mb-2">What is GDPR?</h2>
        <p>
          GDPR is an EU-wide privacy and data protection law that regulates how EU
          residents&rsquo; data is protected by companies and enhances the control the
          EU residents have, over their personal data.
        </p>
        <p>
          The GDPR is relevant to any globally operating company and not just the
          EU-based businesses and EU residents. Our customers&rsquo; data is important
      ...
      <section>
        <h2 className="font-display text-lg font-bold mb-2">What is personal data?</h2>
        <p>
          ...
          data extends beyond a person&rsquo;s name or email address. Some examples
          include financial information, political opinions, genetic data, biometric
          data, IP addresses, physical address, sexual orientation, and ethnicity.
        </p>
      </section>

      <section>
        <h2 className="font-display text-lg font-bold mb-2">The Data Protection Principles include requirements such as:</h2>
        <ul className="list-disc pl-6 space-y-1">
          <li>
      ...
      <section>
        <h2 className="font-display text-lg font-bold mb-2">Why is GDPR important?</h2>
        <p>
          GDPR adds some new requirements regarding how companies should protect
          individuals&rsquo; personal data that they collect and process. It also
          raises the stakes for compliance by increasing enforcement and imposing
          greater fines for breach. Beyond these facts it&rsquo;s simply the right
          thing to do. At Friday Career Coaching we strongly believe that your data
      ...
      <section>
        <h2 className="font-display text-lg font-bold mb-2">
          Individual Data Subject&rsquo;s Rights &mdash; Data Access, Portability and Deletion
        </h2>
        <p>
          We are committed to helping our customers meet the data subject rights
          requirements of GDPR. Friday Career Coaching processes or stores all personal
          data in fully vetted, DPA compliant vendors. We do store all conversation and
        ...
        <p>
          ...
          personal data. We got you! We&rsquo;ve been set up as self service from the
          start and have always given you access to your data and your customers data.
          Our customer support team is here for you to answer any questions you might
          have about working with the API.
        </p>
      </section>

      <section>
        <h2 className="font-display text-lg font-bold mb-2">California Residents</h2>
        <p>
        ...
        <ul className="list-disc pl-6 space-y-1">
          <li>
            <strong>Right to Know and Access.</strong> You may submit a verifiable
            request for information regarding the: (1) categories of Personal
            Information we collect, use, or share; (2) purposes for which categories
            of Personal Information are collected or used by us; (3) categories of
          ...
          <li>
            <strong>Right to Equal Service.</strong> We will not discriminate against
            you if you exercise your privacy rights.
          </li>
          <li>
            <strong>Right to Delete.</strong> You may submit a verifiable request to
            close your account and we will delete Personal Information about you that
            we have collected.
          </li>
          <li>
            Request that a business that sells a consumer&rsquo;s personal data, not
            sell the consumer&rsquo;s personal data.
          </li>
        </ul>
        <p>
          If you make a request, we have one month to respond to you. If you would
          like to exercise any of these rights, please contact us. We do not sell the
          Personal Information of our users. For more information about these rights,
          please contact us.
        </p>
      </section>
