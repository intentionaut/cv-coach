  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <p className="font-body text-lg text-text-secondary max-w-2xl mb-10 leading-relaxed">
        Getting hired in this industry depends on being able to explain what you&apos;ve
        actually done — on paper, in an interview, and out loud on a phone call you
        weren&apos;t expecting. That&apos;s a skill, and it&apos;s the one Friday is built to
        teach.
      </p>
